...
- 스프링이 제공하는 **핵심가치**와 **원리**를 제대로 이해하고, 스프링 기본기를 확실하게 다질 수 있다.
...
- [1. 객체 지향 설계와 스프링](#1-객체-지향-설계와-스프링)  
  ...
  - [1-4. 좋은 객체지향 프로그래밍](#1-4-좋은-객체지향-프로그래밍)
    - [1-4-1. 다형성](#1-4-1-다형성)
  - [1-5. 좋은 객체지향 설계의 5가지 원칙 - SOLID](#1-5-좋은-객체지향-설계의-5가지-원칙---solid)
...
> 
> **( 영한님: 가끔 악덕 면접관한테 걸리면 면접에 나올수도 있습니다. (ㅋㅋㅋ) )**

### 1-5. 좋은 객체지향 설계의 5가지 원칙 - SOLID
